...
-- Created: 2024-12-19 23:58:00
-- Description: Add email templates for the admin email composer
...
CREATE INDEX "idx_email_template_created_by" ON "EmailTemplate"("createdBy");
CREATE INDEX "idx_email_template_created_at" ON "EmailTemplate"("createdAt");
...
INSERT INTO "EmailTemplate" (name, subject, content, "htmlContent", "createdBy") VALUES
(
  'Welcome Email',
  'Welcome to {{siteName}}!',
